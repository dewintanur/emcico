...
class KonfirmasiDutyOfficerNotification extends Notification
{
    use Queueable;
    ...
    public function toDatabase($notifiable)
    {
        ...
        \Log::info('Debugging: Kode Booking (Siap Checkout) = ' . ($kode_booking ?? 'Tidak ada'));

        return [
            'message' => "Duty Officer telah mengkonfirmasi bahwa ruangan {$this->ruangan->nama_ruangan} Siap Checkout.",
